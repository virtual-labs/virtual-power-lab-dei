...
* Objective
  - To Simulate the “To determine the sub-transient (xd��), transient (xd�) and steady state reactance (xd) of a synchronous machine ” experiment
...
* Test Steps
  ...
  4. Set the value and click on the 'three phase open circuited'
...
* Expected result
  ...
  4. The current gets short circuited and the graphs of Ia,Ib and Ic should be displayed on the screen
