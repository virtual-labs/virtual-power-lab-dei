...
* Test Steps
  ...
  3. Click on "Simulation of Buchholz Relay for severe faults" link.
  4. Click on the pump .
  5. Now open all the values(v1,v2,v3) .
  6. Click on refresh everything button
...
* Expected result
  ...
  6. The simulation should getback to the starting position.
