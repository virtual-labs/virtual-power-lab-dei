...
* Objective
  - To view and take the Quiz “To study the synchronization of the alternator with infinite bus bar” experiment
...
* Expected result
  ...
  3. If the selected option is correct then a successful message should be displayed and if the selected option is wrong then a message should be displayed with the correct option.
