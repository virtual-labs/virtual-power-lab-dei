...
* Test Steps
  ...
  4. Enter the valid data in the input fields ( Change in Speed(rpm),Variation in Rf(Ω)).
...
* Expected result
  ...
  4. The result should be displayed in the output fields (Frequency(Hz),Terminal Voltage(V)).
