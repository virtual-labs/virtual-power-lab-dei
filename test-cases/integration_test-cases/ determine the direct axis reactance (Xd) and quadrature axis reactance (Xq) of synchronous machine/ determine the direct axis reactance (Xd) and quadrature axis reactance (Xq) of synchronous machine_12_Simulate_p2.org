...
* Test Steps
  ...
  4. Set invalid 'Max Angle' in Variation in Self Inductance with angle and select the phase (either phase1,phase2 or phase3)

* Expected result
  1. Simulation page should be opened
  2. Content should be present with no distortions and Junk character
  3. An error message should be displayed on the screen as Set valid 'Max Angle'.
