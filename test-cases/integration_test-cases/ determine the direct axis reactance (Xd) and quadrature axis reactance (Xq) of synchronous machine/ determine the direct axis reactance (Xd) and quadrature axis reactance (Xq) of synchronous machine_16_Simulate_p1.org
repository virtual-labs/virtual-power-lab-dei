...
* Test Steps
  ...
  4. Set valid 'Max Angle' in Variation in Self Inductance with angle,Variation in Mutual Inductance with angle and Armature Current and then select the all the phases (phase1,phase2,and phase3).
