...
* Test Steps
  ...
  4. Set valid 'Max Angle' in Variation in Self Inductance with angle,Variation in Mutual Inductance with angle and Armature Current and then select the phase 3
...
* Expected result
  ...
  4. The colour of the graph should be blue.
