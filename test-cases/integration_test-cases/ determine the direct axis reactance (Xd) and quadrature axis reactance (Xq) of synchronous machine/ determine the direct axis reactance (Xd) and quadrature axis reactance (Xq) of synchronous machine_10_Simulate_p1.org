...
* Test Steps
  ...
  3. Click on Checking Phase Sequence of Synchronous Machine link.
  4. Click on phase sequence checking link.
  5. Connect the wires as follows: R-1,Y-2,B-3
  6. Click on the clear connections button
...
* Expected result
  ...
  4. When we click on phase sequence checking link ,it should redirect to the simulation flow diagram page.
  5. All the wires connected should be removed.
